# Capability: reports-ui

## Purpose

The reports-ui capability provides a browser page for viewing filtered, sorted, paginated reports and exporting the current page to CSV.
